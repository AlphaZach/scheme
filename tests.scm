...
sum
; expect (lambda (n total) (if (zero? n) total (- n 1)))
...
(begin (define a (+ 1 2)) (define b (* 3 4)) (* a b))
; expect 36

(begin (define a '(1 2)) (define b '(3 . 4)) (+ 1 1))
; expect 2

(lambda (a b) (* (+ a b) (- a b)))
; expect (lambda (a b) (* (+ a b) (- a b)))

(lambda (a b) (define a 1) (define b 2))
; expect (lambda (a b) (define a 1) (define b 2))
